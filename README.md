...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/text-ai-generator
```

A live public deployment of this template is available at [https://text-ai-generator.templates.workers.dev](https://text-ai-generator.templates.workers.dev)
